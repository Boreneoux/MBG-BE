...
export const EMAIL_VERIFICATION_EXPIRY_MINUTES = parseInt(
  process.env.EMAIL_VERIFICATION_EXPIRY_MINUTES || '60',
  10
);
export const PASSWORD_RESET_EXPIRY_MINUTES = parseInt(
...
export const MIDTRANS_SNAP_URL =
  process.env.MIDTRANS_SNAP_URL || 'https://app.sandbox.midtrans.com/snap/v1';
export const MIDTRANS_API_URL =
  process.env.MIDTRANS_API_URL || 'https://api.sandbox.midtrans.com';
export const MIDTRANS_WEBHOOK_URL =
  process.env.MIDTRANS_WEBHOOK_URL ||
  'http://localhost:8000/api/orders/webhook/payment';
